...
def create_lmdbs(split_num, cwd):
    ...
    call([lmdb_tool_path, "--resize_height=227", "--resize_width=227", "../images/", trainfile, train_lmdb_path])
    call([lmdb_tool_path, "--resize_height=227", "--resize_width=227", "../images/", testfile, test_lmdb_path])
